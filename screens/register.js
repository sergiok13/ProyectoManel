  ...
  render() {
    return (
      ...
      <View style={{flex: 2/6}}>
          ...
          <TextInput style={{borderWidth: 2, margin: 9}} placeholder="Repite tu Contraseña" backgroundColor="gray" onChangeText = {value => this.setState({contra: value})}></TextInput>
      </View>
        <View style={{flex: 2/6}}>
